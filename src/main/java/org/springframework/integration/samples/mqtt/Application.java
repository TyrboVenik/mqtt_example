...
public class Application {
	...
	public IntegrationFlow mqttOutFlow() {
		System.out.println("mqttOutFlow");
	...
	public MessageHandler mqttOutbound() {
		...
		MqttPahoMessageHandler messageHandler = new MqttPahoMessageHandler("pidrila1", mqttClientFactory());
	...
	public MessageProducerSupport mqttInbound() {
		System.out.println("mqttInbound");
		MqttPahoMessageDrivenChannelAdapter adapter = new MqttPahoMessageDrivenChannelAdapter("pidrila",
